...
var digit_13798 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_13799__$1 = (vlq >>> (5));
while(true){
if((vlq_13799__$1 > (0))){
var digit_13800__$1 = (digit_13798 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_13800__$1));

var G__13801 = (vlq_13799__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__13802 = (vlq_13799__$1 >>> (5));
digit_13798 = G__13801;
vlq_13799__$1 = G__13802;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_13798));
}
break;
}
...
var G__13803 = i__$1;
var G__13804 = result__$1;
var G__13805 = shift__$1;
i = G__13803;
result = G__13804;
shift = G__13805;
continue;
