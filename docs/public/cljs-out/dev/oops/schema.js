...
var G__17082 = cljs.core.first.call(null,element_str);
switch (G__17082) {
case "?":
arr.push((1));
...
var G__17084 = cljs.core.next.call(null,items);
items = G__17084;
continue;
} else {
return null;
...
var G__17085 = cljs.core.next.call(null,items);
items = G__17085;
continue;
} else {
return null;
...
var G__17087 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__17087;
continue;
} else {
return true;
...
switch (G__17090) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__17090){
return (function (p1__17088_SHARP_){
return cljs.core.not_EQ_.call(null,p1__17088_SHARP_,(2));
});})(G__17090))
))){
...
return cljs.core.not_EQ_.call(null,p1__17089_SHARP_,(1));
});})(G__17090))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17090)].join('')));
